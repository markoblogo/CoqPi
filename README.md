...
- Reviewed extraction fields can be assembled into an unselected context pack draft. A compact review card shows summary, context, links, weak fields, and retrieval state before the owner explicitly saves the pack.
...
2. Knowledge pack lifecycle pass: track assembled/reviewed/saved states so knowledge-derived packs have clearer provenance history.
