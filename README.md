...
2. Knowledge extraction quality pass: add local field extraction from explicitly captured readable files, still behind manifest preview and without URL/folder scanning.
