...
- **Knowledge pack assembly**: reviewed extraction fields can populate an unselected local context pack draft. Assembly is not persistence, selection, or assistant retrieval; the owner must save and select the pack explicitly.
