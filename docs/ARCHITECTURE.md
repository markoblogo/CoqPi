...
- **Knowledge pack assembly/review**: reviewed extraction fields can populate an unselected local context pack draft. A review surface shows summary, context, links, weak fields, and retrieval state before explicit save. Assembly is not persistence, selection, or assistant retrieval.
