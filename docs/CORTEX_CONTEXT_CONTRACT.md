...
- Finder scoring is local and deterministic. It may derive scenario-aware `fitScore`, `missingInfo`, and `nextAction` from compact extracted fields, but owner-provided review fields remain authoritative and no external scoring service is called.
